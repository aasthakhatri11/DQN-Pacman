...
The agent was trained with a constrained replay buffer and reduced episode length to allow faster experimentation. While the training setup is lightweight, it captures the essential behaviour of a DQN agent and produces meaningful results.
...
Peak rewards during training reached approximately 150–190, indicating that the agent learned meaningful navigation strategies despite limited training.
